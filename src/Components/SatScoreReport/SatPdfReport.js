...
const NewsComponent = () => {
  ...
  const generatePDF = () => {
    ...
    const headerHeight = 8; // Adjust the height as needed
    const topMargin = 0;
      ...
      callback: function (pdf) {
        ...
        for (let i = 1; i <= pageCount; i++) {
          ...
          titles.forEach((title) => {
            ...
            const pageTopOffset = (i - 1) * 20; // Each page will have more offset due to the previous tops adding up
            const pagePerspectiveTop = realTop % (pdf.getPageHeight() / i);
          ...
          // Add footer
          const fontSize = 6;
          const footer = `© 2023 This content is protected by federal copyright laws, which prohibit its reproduction, whether in entirety or in part, without the explicit written consent of Brilliant Education Group, LLC`;
        ...
        // Save the PDF
        pdf.save('SAT_Diagnostic_Report.pdf');
      },
      x: 10,
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%"
                  ...
                  {results.map((topic) => (
                    ...
                    <tr>
                      ...
                      <td class="rpad">{topic.correct_count} of {topic.topic_count}</td>
                    </tr>
